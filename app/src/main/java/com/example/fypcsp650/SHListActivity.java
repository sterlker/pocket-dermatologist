...
public class SHListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SHListActivity.FetchData().execute();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("path", selectedScan.getImage_sh());
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    int path = Integer.parseInt(jsonObject.getString("path"));
                    String classification = jsonObject.getString("classification");
                    list.add(new ScanHistory(path, classification, "Click for More Details"));
                }
